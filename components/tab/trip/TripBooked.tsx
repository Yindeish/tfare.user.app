...
import TripStartedSheet from "./TripStarted";

const TripBookedSheet = () => {
  const { currentTrip, driverDetails, ticketsInputs } = useAppSelector(
    (state) => state.trip
  );
        ...
        .on(
          ...
          (payload) => {
            ...
            if (query === RideConstants.query.RideBooked) {
              ...
              router.replace("/(tripScreen)/tripMap");
            }
          }
        )
        .subscribe();
  ...
  return (
    <BottomSheetScrollView style={[tw``]} contentContainerStyle={[tw`w-full`]}>
      <PaddedScreen>
        ...
        <View
          style={[
            { flexDirection: "column", gap: 32, marginTop: 20 },
            tw`pb-[15px]`,
          ]}
        >
          {/* Header Section */}
          ...
          >
            ...
            />
            {ticketsInputs?.map((ticket, index) => (
              <BuyTicketListTile
          ...
          <View style={{ width: "100%", flexDirection: "column", gap: 16 }}>
            <CtaBtn
              ...
              onPress={() => {
                ...
                router.replace("/(tripScreen)/tripDetails");
                setTimeout(
                  () =>
                    showBottomSheet(
                      [100, 400, 800],
            ...
            <CtaBtn
              ...
              onPress={() => {}}
              text={{ name: "See later", color: Colors.light.textGrey }}
