        ...
        <View style={[wFull, h('auto'), bg('#FFF7E6'), borderGrey(0.7), borderL(0, ''), borderR(0, ''), py(16), px(20), flexCol, gap(32)]}>
            ...
            <View style={[flex, itemsCenter, justifyBetween]}>
                <View style={[flexCol, gap(8)]}>
                    ...
                    <Text style={[fw700, fs14, c(colors.black)]}>{selectedAvailableTrip?.route?.pickupBusstop?.name}</Text>
                </View>
                ...
                <View style={[flexCol, gap(8)]}>
                    ...
                    <Text style={[fw700, fs14, c(colors.black)]}>{selectedAvailableTrip?.route?.dropoffBusstop?.name}</Text>
                </View>
            </View>
            ...
            <View style={[flex, itemsCenter, justifyBetween]}>
                <View style={[flexCol, gap(8)]}>
                    ...
                    <Text style={[fw500, fs14, c(colors.black)]}>{selectedAvailableTrip?.departureDate} - {selectedAvailableTrip?.departureTime}</Text>
                </View>
                ...
                <View style={[w('auto'), h(45), rounded(100), flex, itemsCenter, gap(16), bg(colors.white), p(16), { borderWidth: 0.7, borderColor: Colors.light.border }]}>
                    ...
                    <Text style={[fs12, fw500, colorBlack]}>{selectedAvailableTrip?.availableSeats} seats Available</Text>
                </View>
            </View>
