...
export default function PaymentInfo() {
  ...
  const { loading, walletHistory } = fetchState;
  ...
  const getWalletHistory = async () => {
    ...
    const walletHistory = returnedData?.transactions;
    setFetchState((prev) => ({
      ...prev,
      loading: false,
  ...
  return (
    <SafeScreen>
      <ScrollView
        ...
        refreshControl={
          <RefreshControl onRefresh={() => getUserWallet().then(getWalletHistory)} refreshing={loading} />
        }
      >
        <PaddedScreen>
          {/* Page Header */}
          ...
          <View style={[wFull, flexCol, gap(40)]}>
            ...
            >
              <View style={[flexCol, gap(16), w(126), h(60)]}>
                ...
                <Text style={[neurialGrotesk, fw700, { fontSize: 22 }]}>
            ...
            <View style={[wFull, flexCol, gap(32)]}>
              ...
              <View style={[flexCol, gap(8)]}>
                <Text style={[fs12, fw400, colorBlack, tw`capitalize`]}>
                  {wallet?.bank_name}
                </Text>
            ...
            <View style={[wFull, flexCol, gap(32)]}>
              <AccountPageBlockTitle title="Wallet History" />
                ...
                {walletHistory?.map((item, index) => (
                  ...
                  >
                    <View style={[flexCol, itemsStart, justifyBetween, hFull]}>
                      ...
                      <Text style={[colorTextGrey, fs12, fw400]}>
                        {item.date}
                      </Text>
                    </View>
                    ...
                    <View style={[flexCol, itemsStart, justifyBetween, hFull]}>
                      ...
                      >{`₦${item.amount}`}</Text>
                      <Text style={[colorTextGrey, fw400, fs12]}>
                        {item.time}
                      </Text>
                    </View>
                  </View>
