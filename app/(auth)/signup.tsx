...
import { flex, flexCenter, flexCol, flexYCenter, hFull, itemsCenter, itemsStart, justifyBetween, justifyEnd, justifyStart, mLAuto, mRAuto, mXAuto, pAuto, pLAuto, wFull, wHFull } from '@/utils/styles';
import Colors, { colors } from '@/constants/Colors';
import { Entypo } from '@expo/vector-icons';
import Checkbox from 'expo-checkbox';


const { signUpTitle, textInput, genderSelectText, genderMenuDropdown, form, signUpBtn, signUpText, noAccount, signupLink, invalidEntryText, checkbox } = StyleSheet.create({
    signUpTitle: {
        fontWeight: '500',
        fontSize: 32,
        lineHeight: 32.08,
        ...
        <SafeScreen>
            <View style={[wFull, hFull, flex, flexCol, itemsStart, justifyEnd, { gap: 40, height: 'auto' }]}>
                ...
                <Pressable style={[wFull, signUpBtn]}>
                    <Text style={[wHFull, pAuto, flexCenter, signUpText]}>Create</Text>
                </Pressable>
